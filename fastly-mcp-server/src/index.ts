...
const toolDefinitionMap: Map<string, McpToolDefinition> = new Map([
  ...
  ["updateservice", {
    ...
    inputSchema: {"type":"object","properties":{"requestBody":{"type":"object","properties":{"name":{"type":"string","description":"The name of the service."},"comment":{"type":"string","description":"A freeform descriptive note."}},"description":"The JSON request body."}},"required":["requestBody"]},
    method: "put",
    pathTemplate: "/service/{service_id}",
    executionParameters: [],
    requestBodyContentType: "application/json",
  ...
  ["createdomain", {
    ...
    inputSchema: {"type":"object","properties":{"requestBody":{"type":"object","properties":{"name":{"type":"string","description":"The name of the domain or domains associated with this service."},"comment":{"type":"string","description":"A freeform descriptive note."}},"required":["name"],"description":"The JSON request body."}},"required":["requestBody"]},
    method: "post",
    pathTemplate: "/service/{service_id}/domain",
    executionParameters: [],
    requestBodyContentType: "application/json",
  ...
  ["createbackend", {
    ...
    inputSchema: {"type":"object","properties":{"requestBody":{"type":"object","properties":{"name":{"type":"string","description":"The name of the backend."},"address":{"type":"string","description":"A hostname, IPv4, or IPv6 address for the backend."},"port":{"type":"number","description":"Port number of the address."},"override_host":{"type":"string","description":"The hostname to override the Host header."},"connect_timeout":{"type":"number","description":"How long to wait for a timeout in milliseconds."},"max_conn":{"type":"number","description":"Maximum number of connections."},"ssl_check_cert":{"type":"boolean","description":"Be strict on checking SSL certs."},"use_ssl":{"type":"boolean","description":"Whether or not to use SSL to reach the backend."},"weight":{"type":"number","description":"Weight used to load balance this backend against others."},"auto_loadbalance":{"type":"boolean","description":"Whether or not this backend should be automatically load balanced."}},"required":["name","address","port"],"description":"The JSON request body."}},"required":["requestBody"]},
    method: "post",
    pathTemplate: "/service/{service_id}/version/{version_id}/backend",
    executionParameters: [],
    requestBodyContentType: "application/json",
  ...
  ["updatebackend", {
    ...
    inputSchema: {"type":"object","properties":{"requestBody":{"type":"object","properties":{"name":{"type":"string","description":"The name of the backend."},"address":{"type":"string","description":"A hostname, IPv4, or IPv6 address for the backend."},"port":{"type":"number","description":"Port number of the address."},"override_host":{"type":"string","description":"The hostname to override the Host header."},"connect_timeout":{"type":"number","description":"How long to wait for a timeout in milliseconds."},"max_conn":{"type":"number","description":"Maximum number of connections."},"ssl_check_cert":{"type":"boolean","description":"Be strict on checking SSL certs."},"use_ssl":{"type":"boolean","description":"Whether or not to use SSL to reach the backend."},"weight":{"type":"number","description":"Weight used to load balance this backend against others."},"auto_loadbalance":{"type":"boolean","description":"Whether or not this backend should be automatically load balanced."}},"description":"The JSON request body."}},"required":["requestBody"]},
    method: "put",
  ...
  ["createcachesetting", {
    ...
    inputSchema: {"type":"object","properties":{"requestBody":{"type":"object","properties":{"name":{"type":"string","description":"Name for the cache settings object."},"ttl":{"type":"number","description":"Maximum time to live for the cache in seconds."},"stale_ttl":{"type":"number","description":"Maximum time to serve stale object in seconds."},"action":{"type":"string","description":"One of pass, cache, or restart, indicating how to handle the cache.","enum":["pass","cache","restart"]},"cache_condition":{"type":"string","description":"Name of the cache condition controlling when this configuration applies."}},"required":["name","action"],"description":"The JSON request body."}},"required":["requestBody"]},
    method: "post",
    pathTemplate: "/service/{service_id}/version/{version_id}/cache_settings",
    executionParameters: [],
    requestBodyContentType: "application/json",
  ...
  ["updatecachesetting", {
    ...
    inputSchema: {"type":"object","properties":{"requestBody":{"type":"object","properties":{"name":{"type":"string","description":"Name for the cache settings object."},"ttl":{"type":"number","description":"Maximum time to live for the cache in seconds."},"stale_ttl":{"type":"number","description":"Maximum time to serve stale object in seconds."},"action":{"type":"string","description":"One of pass, cache, or restart, indicating how to handle the cache.","enum":["pass","cache","restart"]},"cache_condition":{"type":"string","description":"Name of the cache condition controlling when this configuration applies."}},"description":"The JSON request body."}},"required":["requestBody"]},
    method: "put",
  ...
  ["purgebykey", {
    ...
    inputSchema: {"type":"object","properties":{"requestBody":{"type":"object","properties":{"surrogate_keys":{"type":"array","description":"List of surrogate keys to purge","items":{"type":"string"}}},"required":["surrogate_keys"],"description":"The JSON request body."}},"required":["requestBody"]},
    method: "post",
  ...
  ["createwaf", {
    ...
    inputSchema: {"type":"object","properties":{"requestBody":{"type":"object","properties":{"prefetch_condition":{"type":"string","description":"Name of the corresponding condition object."},"response":{"type":"string","description":"Name of the corresponding response object."}},"required":["prefetch_condition"],"description":"The JSON request body."}},"required":["requestBody"]},
    method: "post",
    pathTemplate: "/service/{service_id}/version/{version_id}/waf",
    executionParameters: [],
    requestBodyContentType: "application/json",
  ...
  ["updatewafrule", {
    ...
    inputSchema: {"type":"object","properties":{"requestBody":{"type":"object","properties":{"status":{"type":"string","description":"Rule status.","enum":["log","block","score"]}},"required":["status"],"description":"The JSON request body."}},"required":["requestBody"]},
    method: "patch",
  ...
  ["createdictionary", {
    ...
    inputSchema: {"type":"object","properties":{"requestBody":{"type":"object","properties":{"name":{"type":"string","description":"Name for the Dictionary."},"write_only":{"type":"boolean","description":"Determines if items in the dictionary are readable or not."}},"required":["name"],"description":"The JSON request body."}},"required":["requestBody"]},
    method: "post",
    pathTemplate: "/service/{service_id}/version/{version_id}/dictionary",
    executionParameters: [],
    requestBodyContentType: "application/json",
  ...
  ["createdictionaryitem", {
    ...
    inputSchema: {"type":"object","properties":{"requestBody":{"type":"object","properties":{"item_key":{"type":"string","description":"Dictionary item key."},"item_value":{"type":"string","description":"Dictionary item value."}},"required":["item_key","item_value"],"description":"The JSON request body."}},"required":["requestBody"]},
    method: "post",
    pathTemplate: "/service/{service_id}/version/{version_id}/dictionary/{dictionary_id}/items",
    executionParameters: [],
    requestBodyContentType: "application/json",
  ...
  ["createvcl", {
    ...
    inputSchema: {"type":"object","properties":{"requestBody":{"type":"object","properties":{"name":{"type":"string","description":"The name of this VCL."},"content":{"type":"string","description":"The VCL code."},"main":{"type":"boolean","description":"Set to true when this is the main VCL, otherwise false."}},"required":["name","content"],"description":"The JSON request body."}},"required":["requestBody"]},
    method: "post",
    pathTemplate: "/service/{service_id}/version/{version_id}/vcl",
    executionParameters: [],
    requestBodyContentType: "application/json",
  ...
  ["getservicestatssummary", {
    ...
    inputSchema: {"type":"object","properties":{"from":{"type":"string","format":"date-time","description":"Timestamp from which to begin gathering stats (UTC)"},"to":{"type":"string","format":"date-time","description":"Timestamp to end gathering stats (UTC)"}}},
    method: "get",
